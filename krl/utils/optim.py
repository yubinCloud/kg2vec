...
def create_optimizer(optimizer_name: Union[str, Optimizer], model: KRLModel, lr: float) -> Optimizer:
    """create a optimizer from a optimizer name
    """
    # if the param `optimizer_name` is a Optimizer, return it now.
    if isinstance(optimizer_name, Optimizer):
